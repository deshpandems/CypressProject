describe('Download Invoice after purchase order', () => {
    it('Download Invoice after purchase order', () => {
        ...
        cy.xpath("//div[@class='modal-content']//a[@href='/login']").click();
        ...
        //click on download invoice button and verify invoice is downloaded successfully.
        cy.xpath("//a[@href='/download_invoice/900']").click();
